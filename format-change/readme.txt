...
IP=localhost
#HLS1=http://$IP:8000/video1/resolution_change.m3u8     # old video, works with      gstreamer 1.21
HLS1=http://$IP:8000/video2/resolution_change.m3u8      # new video, works also with gstreamer 1.20
...
for((i=0;i<20000;i++)); do
    ...
    gst-launch-1.0 --no-fault souphttpsrc location="$HLS1" ! hlsdemux ! parsebin ! v4l2h264dec ! glimagesink &
